...
var MeanMedianMode = function() {
    ...
    //find the numbers passed to the program:
    //    var nums,
    var obj = {};
    //        sum = 0,
    //        findMode = {},
    ...
    this.mean = function() {
        ...
        obj.mean = (sum / l);
        //console.log("inside the mean method: " + obj.mean);
        //console.log(obj);
        return obj.mean;
    };
    ...
    this.median = function() {
        ...
        //console.log("inside the median method " + obj.median);
        //console.log(obj);
        return obj.median;
    };
